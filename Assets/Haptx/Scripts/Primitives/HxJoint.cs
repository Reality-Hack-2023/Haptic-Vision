...
public class HxJoint : MonoBehaviour, ISerializationCallbackReceiver {
  ...
  public void UpdateJoint() {
    ...
    // Make sure to keep the current anchor val the same, disabling clears it.
    Vector3 tempAnchorVal = _configurableJoint.connectedAnchor;
    _configurableJoint.autoConfigureConnectedAnchor = false;
    _configurableJoint.connectedAnchor = tempAnchorVal;
