...
class HxRigidbodyCallbacks : HaptxApi.SimulationCallbacks {
  ...
  private HaptxApi.Vector3D _positionM = HxReusableObjectPool<HaptxApi.Vector3D>.Get();

  //! Re-used to avoid unnecessary GC allocations caused by SWIG.
  private HaptxApi.Quaternion _rotation = HxReusableObjectPool<HaptxApi.Quaternion>.Get();

  //! Re-used to avoid unnecessary GC allocations caused by SWIG.
  private HaptxApi.Vector3D _lossyScale = HxReusableObjectPool<HaptxApi.Vector3D>.Get();

  //! Re-used to avoid unnecessary GC allocations caused by SWIG.
  private HaptxApi.Transform _transform = HxReusableObjectPool<HaptxApi.Transform>.Get();

  //! Re-used to avoid unnecessary GC allocations caused by SWIG.
  private HaptxApi.Vector3D _linearVelocityM_S = HxReusableObjectPool<HaptxApi.Vector3D>.Get();

  //! Re-used to avoid unnecessary GC allocations caused by SWIG.
  private HaptxApi.Vector3D _angularVelocityRad_S = HxReusableObjectPool<HaptxApi.Vector3D>.Get();
  ...
  public override HaptxApi.Vector3D getPositionM() {
    if (_rigidbody != null) {
      HxShared.HxFromUnity(_rigidbody.worldCenterOfMass, ref _positionM);
    }
    return _positionM;
  }
  ...
  public override HaptxApi.Quaternion getRotation() {
    if (_rigidbody != null) {
      HxShared.HxFromUnity(_rigidbody.rotation, ref _rotation);
    }
    return _rotation;
  }
  ...
  public override HaptxApi.Vector3D getLossyScale() {
    if (_rigidbody != null) {
      HxShared.HxFromUnityScale(_rigidbody.transform.lossyScale, ref _lossyScale);
    }
    return _lossyScale;
  }
  ...
  public override HaptxApi.Transform getTransform() {
    if (_rigidbody != null) {
      ...
      HxShared.HxFromUnity(wTransform, ref _transform);
    }
    return _transform;
  }
  ...
  public override HaptxApi.Vector3D getLinearVelocityM_S() {
    if (_rigidbody != null) {
      HxShared.HxFromUnity(_rigidbody.velocity, ref _linearVelocityM_S);
    }
  ...
  public override HaptxApi.Vector3D getAngularVelocityRad_S() {
    if (_rigidbody != null) {
      HxShared.HxFromUnityAngularVelocity(_rigidbody.angularVelocity, ref _angularVelocityRad_S);
    }
...
class HxTransformCallbacks : HaptxApi.SimulationCallbacks {
  ...
  private Matrix4x4 _lTransform = Matrix4x4.identity;
  ...
  //! Re-used to avoid unnecessary GC allocations caused by SWIG.
  private HaptxApi.Transform _hxTransform = HxReusableObjectPool<HaptxApi.Transform>.Get();
  ...
  public override HaptxApi.Vector3D getPositionM() {
    if (_transform != null) {
      HxShared.HxFromUnity(GetUnityWorldTransform().MultiplyPoint3x4(Vector3.zero),
          ref _positionM);
    }
    return _positionM;
  }
  ...
  public override HaptxApi.Quaternion getRotation() {
    if (_transform != null) {
      HxShared.HxFromUnity(GetUnityWorldTransform().rotation, ref _rotation);
    }
    return _rotation;
  }
  ...
  public override HaptxApi.Vector3D getLossyScale() {
    if (_transform != null) {
      HxShared.HxFromUnityScale(GetUnityWorldTransform().lossyScale, ref _lossyScale);
    }
    return _lossyScale;
  }
  ...
  public override HaptxApi.Transform getTransform() {
    if (_transform != null) {
      HxShared.HxFromUnity(GetUnityWorldTransform(), ref _hxTransform);
    }
    return _hxTransform;
  }
  ...
  public override HaptxApi.Vector3D getLinearVelocityM_S() {
    if (_rigidbody != null) {
      HxShared.HxFromUnity(_rigidbody.GetPointVelocity(
          GetUnityWorldTransform().MultiplyPoint3x4(Vector3.zero)), ref _linearVelocityM_S);
    }
    return _linearVelocityM_S;
  }
